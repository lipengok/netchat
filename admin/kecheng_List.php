...
课程信息管理 </td>
 ...
 <tr>
    <td align="left">
		...
		<tr>
       <th align="left" scope="col">课程名称</th>
...
?>
		<tr>
<td><?php echo $data[migncheng]?></td>
<td><?php echo $data[faburen]?></td>
<td><?php echo $data[shijian]?></td>

<td><a href=kecheng.php?action=mod&id=<?php echo $data[id]?>>修改</a>   <a href="del.php?id=<?php echo $data[id]?>&tn=kecheng" onClick="return confirm('真的要删除？')">删除</a></td>
		  </tr>
		   <?php 
		    }
		      ?>
